    ...
    <div class="container">
            ...
            <tbody>
                ...
                if($result) {
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$row['HouseCertificationNo']."</td>";
                        echo "<td>".$row['GuardName']."</td>";
                        if($row["ShiftDay"] == "1") {
                            echo "<td>Day</td>";
                        } else {
                            echo "<td>Night</td>";
                        }
                        echo "<td>".$row['GuardAddress']."</td>";
                        echo "<td>".$row['GuardNID']."</td>";
                        echo "</tr>";
                    }
                    mysqli_free_result($result); // Free result set
                } else {
        ...
        <table border="1">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM `servant`";
                $result = mysqli_query($link, $sql);

                if($result) {
                    while($row = mysqli_fetch_assoc($result)) {
                        echo "<tr>";
                        echo "<td>".$row['ServantID']."</td>";
                        echo "<td>".$row['ServantName']."</td>";
                        echo "<td>".$row['ServantAddress']."</td>";
                        echo "<td>".$row['ServantPhoneNo']."</td>";
                        echo "</tr>";
                    }
                    mysqli_free_result($result); // Free result set
                } else {
